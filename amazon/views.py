...
class SignUp(generic.CreateView):
    ...
    def form_valid(self, form):
        ...
        subject_template = get_template('amazon/mail_templates/sign_up/subject.txt')
        subject = subject_template.render(context)

        message_template = get_template('amazon/mail_templates/sign_up/message.txt')
...
def update_cart_item_amount(request):
    ...
    new_amount = request.POST.get('amout')
